  ...
  return (
    <div className={AlienStyles.container}>
      <div className={AlienStyles.alien}>
        <svg
          class={AlienStyles.spaceship}
          xmlns="http://www.w3.org/2000/svg"
          viewbox="0 0 109.3 116.8"
        >
          <g
            class={`${AlienStyles.leg} ${AlienStyles.leg__4} ${AlienStyles.legMoving}`}
            id="leg-4"
          >
            <path
              class={AlienStyles.leg}
              d="M83.7 99.6l-8.8-13c-.8-1.1-.4-2.7.7-3.4 1.2-.7 2.7-.3 3.3.9L86.4 98c.4.7.1 1.7-.6 2.1-.7.4-1.6.2-2.1-.5z"
            ></path>
            <path
              class={`${AlienStyles.leg} ${AlienStyles.leg__4__tip} ${AlienStyles.legMovingTip}`}
              d="M82.3 107.1l1.8-8.6c.1-.7.8-1.1 1.5-.9.7.2 1.1.9.8 1.5l-2.7 8.4-2 4.7.6-5.1z"
            ></path>
          </g>
          <g
            class={`${AlienStyles.leg} ${AlienStyles.leg__1} ${AlienStyles.legMoving}`}
            id="leg-1"
          >
            <path
              class={AlienStyles.leg}
            ...
            ></path>
            <path
              class={`${AlienStyles.leg} ${AlienStyles.leg__1__tip} ${AlienStyles.legMovingTip}`}
              d="M24.9 107.1l-1.8-8.6c-.1-.7-.8-1.1-1.5-.9-.7.2-1.1.9-.8 1.5l2.7 8.4 2 4.7-.6-5.1z"
            ></path>
          </g>
          <g id="alien">
            <path
              class={AlienStyles.st1}
              id="body"
          ...
          ></path>
          <circle class={AlienStyles.st2} cx="54.9" cy="41.2" r="3.1"></circle>
          <circle class={AlienStyles.st2} cx="75.1" cy="44.8" r="3.1"></circle>
          <circle class={AlienStyles.st3} cx="56.3" cy="40.2" r=".9"></circle>
          <circle class={AlienStyles.st3} cx="53.4" cy="42.1" r=".9"></circle>
          <circle class={AlienStyles.st3} cx="76.6" cy="43.9" r=".9"></circle>
          <circle class={AlienStyles.st3} cx="73.7" cy="45.7" r=".9"></circle>
        </g> */}
            </g>
          </g>
          <g id="spaceship">
            <path
              class={AlienStyles.st4}
              d="M37.8 92.6c-7-1.6-14.1-7.6-14.9-11h67S57.7 97 37.8 92.6z"
            ></path>
            <path
              class={AlienStyles.st5}
            ...
            ></path>
            <g class={AlienStyles.lantern_1} id="lantern_1">
              <circle
          ...
          <g
            class={`${AlienStyles.leg} ${AlienStyles.leg__3} ${AlienStyles.legMoving}`}
            id="leg-3"
          >
            <path
            ...
            ></path>
            <path
              class={`${AlienStyles.leg} ${AlienStyles.leg__3__tip} ${AlienStyles.legMovingTip}`}
              d="M69.4 111.7l1.8-8.6c.1-.7.8-1.1 1.5-.9.7.2 1.1.9.8 1.5l-2.7 8.4-2 4.7.6-5.1z"
            ></path>
          </g>
          <g
            class={`${AlienStyles.leg} ${AlienStyles.leg__2} ${AlienStyles.legMoving}`}
            id="leg-2"
          >
            <path
              className={AlienStyles.leg}
      ...
      <div className={AlienStyles.bubbleText}>
        <span>Click The moon to see my skills!</span>
      </div>
    </div>
  );
}
